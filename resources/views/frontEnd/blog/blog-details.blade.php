            ...
            <div class="row">
                <div class="col-md-9 post-content" data-aos="fade-up">
                    ...
                    <div class="single-post">
                        <div class="post-meta">
                            <span class="date">{{$blog->category_name}}</span> <span class="mx-1">&bullet;</span> <span>{{$blog->date}}</span>
                        </div>
                       ...
                       <p>{{substr($blog->description,100)}}</p>
                    ...
                    <div class="aside-block">
                        ...
                        <ul class="nav nav-pills custom-tab-nav mb-4" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-category-tab" data-bs-toggle="pill" data-bs-target="#pills-category" type="button" role="tab" aria-controls="pills-category" aria-selected="true">Related Posts</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            <!-- Category -->
                            <div class="tab-pane fade show active" id="pills-category" role="tabpanel" aria-labelledby="pills-category-tab">
                                @foreach($blogWithCateogory as $blog)
